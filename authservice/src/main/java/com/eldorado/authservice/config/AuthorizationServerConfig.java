...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory().withClient(AuthServiceConstants.CLIENT_ID)
				.secret(passwordEncoder.encode(AuthServiceConstants.CLIENT_PASSWORD))
				.accessTokenValiditySeconds(accessTokenExpiryTime).refreshTokenValiditySeconds(refreshTokenExpiryTime)
